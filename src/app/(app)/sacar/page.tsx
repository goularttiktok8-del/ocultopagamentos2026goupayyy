...
export default function WithdrawPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setAmount('');
      setMessage('Saque solicitado. Ele ficará em análise de segurança antes do envio.');
      await refresh();
    } catch (cause) {
